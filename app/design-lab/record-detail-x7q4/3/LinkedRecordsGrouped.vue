...
// One group per predicate. Outgoing predicates use their natural name; all
// incoming links collapse into a single "Mentioned in" group. tagged_with is
// dropped — tags already live in the hero.
